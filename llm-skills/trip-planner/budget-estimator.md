...
estimates from typical/ researched figures; it is not live pricing and must say so.
...
- Base figures on researched/typical costs for the destination; state assumptions.
