...
description: Statically validate generated Spring Boot and Next.js artifacts for common performance anti-patterns, returning a structured pass/fail result.
version: 1.0.0
category: validator
tags:
  - validation
...
| PF-04 | Query filter/sort columns are indexed per the database blueprint | warning |
